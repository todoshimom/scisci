myApp.controller('ModuleNewController', ['ModuleService', 'ComponentService', '$http', '$routeParams', '$scope', '$rootScope', '$timeout', '$interval', function (ModuleService, ComponentService, $http, $routeParams, $scope, $rootScope, $timeout, $interval) {
    console.log('ModuleNewController created');
    let self = this;
